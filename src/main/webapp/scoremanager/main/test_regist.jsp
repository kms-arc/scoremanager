              ...
              <c:forEach var="s" items="${studentList}">
                <tr style="border-bottom:1px solid #ccc;">
                  ...
                  <td style="padding:6px 4px;">
                    <input type="text" name="score_${s.no}" value="${s.point}" style="width:60px;">
                  </td>
                </tr>
              </c:forEach>
            </table>
